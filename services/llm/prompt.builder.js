function buildExtractionPrompt(text, expenseCategories, incomeCategories) {
  ...
  return `
        ...
        If a transaction description contains "Krishna Kuteera" or "Udupi" (case-insensitive), categorize it as a Food-order.
        If a transaction description contains "RMS Ventures" (case-insensitive), categorize it as Office food.
